namespace AndExteriors
{
    ...
    {
        private static string[] databaseKeys = new[] { "Default", "Northwind", "Region1" };
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want AndExteriors migrations to run on your DB.
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "AndExteriors.Migrations." + databaseKey + "DB"
                };
