...
namespace AndExteriors.Region1.Entities
{
    ...
    [ConnectionKey("Region1"), DisplayName("Customers"), InstanceName("Customer"), TwoLevelCached]
    [ReadPermission(Region1.PermissionKeys.Customer.View)]
    [ModifyPermission(Region1.PermissionKeys.Customer.Modify)]
    [DeletePermission(Region1.PermissionKeys.Customer.Delete)]
    ...
    public sealed class CustomerRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Country"), Size(15), LookupFiltering("Region1.CustomerCountry")]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base("Customers")
            {
                LocalTextPrefix = "Region1.Customer";
            }
        }
    }
}