...
namespace AndExteriors.Region1.Entities
{
    ...
    [ConnectionKey("Region1"), DisplayName("Suppliers"), InstanceName("Supplier"), TwoLevelCached]
    [ReadPermission(Region1.PermissionKeys.General)]
    [ModifyPermission(Region1.PermissionKeys.General)]
    [LookupScript("Region1.Supplier")]
    public sealed class SupplierRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Country"), Size(15), LookupFiltering("Region1.SupplierCountry")]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base("Suppliers")
            {
                LocalTextPrefix = "Region1.Supplier";
            }
        }
    }
}